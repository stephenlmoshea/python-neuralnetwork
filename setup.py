...
setup(
  ...
  version = 'v1.5',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/stephenlmoshea/python-neuralnetwork/archive/v1.5.tar.gz',    # I explain this later on
