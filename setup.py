...
setup(
  ...
  version = 'v1.6',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/stephenlmoshea/python-neuralnetwork/archive/v1.6.tar.gz',    # I explain this later on
